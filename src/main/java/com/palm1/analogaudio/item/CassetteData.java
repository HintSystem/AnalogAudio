...
public record CassetteData(String uuid, String url, String name, int color, float volume) {
        public static final Codec<CassetteData> CODEC = RecordCodecBuilder.create(instance -> instance.group(
                        ...
                        Codec.FLOAT.optionalFieldOf("volume", 0.75f).forGetter(CassetteData::volume)).apply(instance, CassetteData::new));
